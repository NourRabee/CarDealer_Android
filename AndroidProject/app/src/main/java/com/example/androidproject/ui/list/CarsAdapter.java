...
public class CarsAdapter extends RecyclerView.Adapter<CarsAdapter.ViewHolder> {
    ...
    public CarsAdapter(Context context, ArrayList<Car> cars, String from) {
    ...
    public void onBindViewHolder(@NonNull CarsAdapter.ViewHolder holder, int position) {
        ...
        double carRating = dataBaseHelper.getAverageRating(LoggedInUser.getInstance().user.getEmail(), car.getId());
        dataBaseHelper.updateCarRating(car.getId(), carRating);

        holder.carRating.setText(Double.toString(carRating));
        ...
        TextView fuel = (TextView) dialog.findViewById(R.id.fuelView);
        ...
        holder.favorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!car.isFavorite()) {
                    ...
                    holder.favorite.startAnimation(animation);
        ...
        confirmReserve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (car.getReserved() == 0 || !dataBaseHelper.isCarReserved(car.getId(), carColor[0])) {
